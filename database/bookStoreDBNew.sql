...
INSERT INTO `employee` VALUES (1,'abc','minh','admin','100',1,100,'2001-01-01 00:00:00.000000',1,'admin',NULL,NULL),(9,'bcd','huong','user','101',1,100,'2001-01-01 00:00:00.000000',1,'user1',1,1),(10,'cde','quynh','user','102',1,100,'2001-01-01 00:00:00.000000',1,'user2',NULL,2),(11,'def','diep','user','103',1,100,'2001-01-01 00:00:00.000000',1,'user3',1,NULL);
...
CREATE TABLE `item` (
  ...
  `quantityItem` int(11) DEFAULT NULL,
  PRIMARY KEY (`idItem`)
...
INSERT INTO `item` VALUES (1,3,'1',5,1),(2,2,'2',4,1),(3,5,'1',6,1),(4,1,'2',2,1),(5,3,'5',5,1),(6,5,'7',7,1),(7,6,'8',8,1),(8,8,'9',9,1),(9,3,'9',4,1);
...
INSERT INTO `storage` VALUES (1,'storage 1 Stress','Storage 1',1);
...
-- Dump completed on 2020-08-02 23:51:58
